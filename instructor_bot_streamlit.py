...
assistant = client.beta.assistants.create(
    name="{0} Instructor".format(course_name),
...
st.title("💬 Instructor Bot for {0} Lecture {1}".format(course_name, st.session_state.lecture_no))
st.write(f"This bot will take you through the entire lecture material for Lecture {st.session_state.lecture_no}.\n\nPlease start interaction by typing 'Hi', 'Hello', etc.")
